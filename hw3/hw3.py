...
product = Mat(({1,2},{1,2}),{(1,1):1,(1,2):1,(2,1):1,(2,2):-1})*Vec({1,2},{1:0.5,2:0.5})
vector_matrix_product_1 = [product.f[each] for each in  product.f]
product =  Mat(({1,2},{1,2}),{(1,1):0,(1,2):0,(2,1):0,(2,2):1})*Vec({1,2},{1:1.2,2:4.44})
vector_matrix_product_2 = [product.f[each] for each in  product.f]
product = Mat(({1,2,3},{1,2,3}),{(1,1):1,(1,2):2,(1,3):3,(2,1):2,(2,2):3,(2,3):4,(3,1):3,(3,2):4,(3,3):5})*Vec({1,2,3},{1:1,2:2,3:3}) 
vector_matrix_product_3 =  [product.f[each] for each in  product.f]
...
part_3_number_cols = 3

part_4_valid = True
part_4_number_rows = 2
part_4_number_cols = 3
...
def dot_product_mat_vec_mult(M, v):
    ...
    return_dict = Vec(M.D[0],{})
    for each in rowdict:
        for roweach in rowdict[each]:
            
            return_dict[each] = return_dict[each] + rowdict[each][roweach]*v[roweach]
    return return_dict
